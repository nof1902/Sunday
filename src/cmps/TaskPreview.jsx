...
import { dynamicCmpOrder } from "./dynamic-iputs/dynamicUtil.sevice";
...
export function TaskPreview({ task, deleteTask, saveTaskCall }) {
  ...
  const cmpsOrder = dynamicCmpOrder()
  ...
  // const taskVal = Object.values(cmpsOrder);
  ...
  return (
    <section className="task-preview">
      ...
      {/* <section className="dynamic-cmps-section">
          <ul className="dynamic-cmps-sectio-list">{
              cmpsOrder.map((cmpType) => (
                <li className="dynamic-cmp-item" key={cmpType}>
                  <DynamicCmp cmpType={cmpType} onUpdate={onUpdate} />
              </li>
            ))}
          </ul>
      </section> */}
...
//const info = {selected+`{cmpType}`: cmpType}
export function DynamicCmp({ cmpType, onUpdate }) {
  let info = {}
  switch (cmpType) {
    case "priority":
