...
export function PriorityCmp({ info, onUpdate }) {
    ...
    return (
        <section className="status-cmp" style={{backgroundColor: infoToEdit.selectedPriority?.backgroundColor || 'rgb(196, 196, 196)'}} onClick={onOpenModal}>
        <span>{infoToEdit.selectedPriority.label}</span>
        {openEditModel && 
