...
export function PriorityCmp({ info, onUpdateEntity }) {
  ...
  function handleInputChange(ev){
    ...
    setInfoToEdit(prevInfo => {
      const updatedPriorities = [...prevInfo.priorities];
      updatedPriorities[idx] = { ...updatedPriorities[idx], label: val }; 
      return { ...prevInfo, priorities: updatedPriorities }; 
    });
  ...
  function handleClickApply() {
    setOpenEditOption(!openEditOption);
    onUpdateEntity(infoToEdit, "priorityPicker")
  }
  ...
  function onChangeColor(rgbColor) {
    ...
    setInfoToEdit(prevInfo => {
      const updatedPriorities = [...prevInfo.priorities];
      updatedPriorities[index] = { ...updatedPriorities[index], backgroundColor: rgbColor };
      return { ...prevInfo, priorities: updatedPriorities }; 
    });
  }
        ...
        <section className="status-model"  ref={modalRef}>
          <section className="status-picker-content">
            <ul className="items-container">
              {infoToEdit.priorities.map((priority, idx) => (
                <li
                  className="item"
                  key={idx}
                  onClick={() => onChangeStatus(priority)}
            ...
            <ul className="items-container">
              {
                ...
                <li className="item" key={idx} >
                  <div className="status-color-div" onClick={() => handleOpenColorModel(idx)} style={{ backgroundColor: priority.backgroundColor }} >
